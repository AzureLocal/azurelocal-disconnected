# azurelocal-disconnected — Claude Code Context
...
- `azurelocal-disconnected-engineer` (model: sonnet) — Expert in `azurelocal-disconnected`: deep knowledge of this repo's structure, conventions, and development workflow.
